      ...
      >
          ...
          <div className="flex flex-wrap justify-center -mx-3">
            <div className="w-full xl:w-1/2 lg:w-2/3 px-3">
              <div className="text-center mb-[30px] relative z-10 -mt-4">
                {/* Shadow Title */}
                <div
                  className="text-[100px] sm:text-[400px] md:text-[350px] lg:text-[300px] font-bold leading-none text-gray-100 opacity-70
                ...
                {/* Main Title */}
                <h2
                  className="text-[28px] sm:text-[36px] md:text-[48px] lg:text-[45px] font-bold leading-tight text-gray-900 mb-4 -mt-5 animate-slideInUp"
                  style={{
                    fontFamily: '"Space Grotesk", sans-serif',
                    animationDelay: '0ms',
                  }}
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-[1500px]">
          <div className="relative">
                  ...
                  <div className="group relative overflow-hidden rounded-xl md:rounded-2xl cursor-pointer mx-2 md:mx-0">
                    ...
                    <div className="overflow-hidden rounded-xl md:rounded-2xl">
                      <img
                        alt={study.title}
                        src={study.image}
                        className="w-full h-[280px] sm:h-[350px] md:h-[450px] object-cover transition-transform duration-500 group-hover:scale-110"
                        loading="lazy"
                      />
                    </div>
            ...
            {/* Custom Controls */}
            <div className="mt-6 md:mt-[40px] flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 max-w-[1404px] mx-auto px-4">
              {/* Slide Counter */}

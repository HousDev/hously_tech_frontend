...
//           <div className="container mx-auto px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-4">
//             {/* Hero Section */}
//             <div className="text-center mt-0 mb-8 sm:mb-10 md:mb- animate-fade-in">
//               <div className="inline-flex items-center gap-1 sm:gap-2 bg-white/80 backdrop-blur-sm px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-full shadow-lg mb-3 sm:mb-6 md:mb-2 border border-slate-200 animate-slide-down max-w-none mx-auto">
//                 <Sparkles className="w-3.5 h-2.5 sm:w-3 sm:h-3 md:w-4 md:h-4 text-amber-500 animate-spin-slow" />
//                 <span className="text-[8px] xs:text-xs sm:text-sm text-slate-600 font-medium whitespace-nowrap">
//                   Formerly Known as AAKAR INFRA SERVICES
//                 </span>
//               </div>

//               {/* Brand Transition */}
//               <div className="relative h-auto min-h-[3rem] sm:min-h-[4rem] md:min-h-[5rem] lg:min-h-[6rem] flex items-center justify-center m-0 p-0">
...
//                       <span>AAKAR</span>
//                     </div>
//                     <div className="text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-slate-400 font-light tracking-wider">
//                       INFRA SERVICES
//                     </div>
//                   </div>
//                 </div>
...
//                   style={{ animation: showNewBrand ? "fadeOut 0.5s ease-in-out 1s forwards" : "none" }}>
//                   <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-blue-500 animate-spin" />
//                 </div>
...
//               {/* Tagline */}
//               <div className="max-w-3xl mx-auto mt-0 mb-4 sm:mb-6 md:mb-8 px-2 sm:px-3 md:px-4">
//                <motion.p
//   className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-800 leading-tight mb-2 sm:mb-3 flex justify-center gap-2 flex-wrap"
//   initial="hidden"
//   animate="visible"
//   variants={{
//     visible: {
...
//   }}
// >
//   {["Evolved.", "Expanded.", "Empowered."].map((word, index) => (
//     <motion.span
//       key={index}
//       variants={{
...
//      <p className="text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed text-slate-500">
//   Reimagined as{" "}
//   <span className="font-semibold text-[#0076d8]">
//     HOUSLY FINNTECH REALTY{" "}
   
//   </span>
//   , we combine Real Estate, Financial Services, and Technology to shape smarter futures.
// </p>

//               </div>

//               {/* Features */}
//                <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-5 px-4 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
//     {[
//       { text: "Three Divisions", icon: Building2 },
//       { text: "One Vision", icon: Target },
//       { text: "Limitless Possibilities", icon: Zap }
//     ].map((item, i) => {
...
//         >
//           {/* Simple Card */}
//           <div className="relative flex items-center gap-2 sm:gap-3 px-4 sm:px-5 py-2.5 sm:py-3 rounded-full bg-white backdrop-blur-sm border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
//             {/* Icon */}
//             <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-slate-700 group-hover:scale-110 transition-transform duration-300" />
            
//             {/* Text */}
//             <span className="text-xs sm:text-sm md:text-base font-medium text-slate-700 tracking-wide whitespace-nowrap">
//               {item.text}
//             </span>
//           </div>
//         </div>
...
//             {/* Timeline Section */}
//             <div className="mt-12 sm:mt-20 md:mt-25 mb-0">
//               {/* Heading */}
//               <div className="text-center mb-6 sm:mb-8 md:mb-10">
//                 <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-1 text-slate-800">
...
//               <div className="max-w-8xl mx-auto px-2 sm:px-3 md:px-4">
//                 {/* MOBILE VIEW - Simple Centered Line */}
//                 <div className="sm:hidden">
//                   <div className="relative py-6">
//                     {/* Simple Centered Vertical Line */}
//                     <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 to-cyan-500 transform -translate-x-1/2"></div>
...
//                         {/* Timeline Card */}
//                         <div className="mt-8 mx-4 bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-slate-200 shadow-lg">
...
//         className="relative mb-20 sm:mb-24 md:mb-28 last:mb-0"
//       >
//         <div
//           className={`w-full sm:w-5/12 md:w-2/5 lg:w-1/3 ${
//             isRight
//               ? "sm:ml-auto" // Right side
//               : "sm:mr-auto sm:ml-8 md:ml-12 lg:ml-16"  // Left side with right shift
//           }`}
//         >
//           <div className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-5 sm:p-6 md:p-8 border border-slate-200 shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 min-h-[400px] sm:min-h-[450px] md:min-h-[500px] text-left">
//             {/* Year Badge */}
//             <div className="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm sm:text-base font-semibold mb-4">
//               {item.year}
//             </div>

//             {/* Title */}
//             <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-800 mb-4 text-left">
//               {item.title}
//             </h3>

//             {/* Description */}
//             <p className="text-sm sm:text-base text-slate-600 leading-relaxed mb-5 text-left">
//               {item.desc}
//             </p>

//             {/* Milestone Badge */}
//             <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 rounded-lg mb-5">
//               <Award className="w-5 h-5 text-emerald-600" />
//               <span className="text-sm font-medium text-emerald-700">{item.milestone}</span>
//             </div>

//             {/* Services Grid */}
//             <div className="pt-5 border-t border-slate-200 text-left">
//               <div className="text-sm font-semibold text-slate-700 mb-3 text-left">
//                 Key Services:
//               </div>

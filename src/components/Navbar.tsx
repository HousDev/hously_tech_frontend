...
//               ? "bg-white shadow-sm px-4 sm:px-6 lg:px-8 py-4"
...
//                           isScrolled || !isHomePage || isOpen ? "text-gray-800" : "text-white"
//                         }`}>
//                           {currentUser?.username || 'Admin'}
//                         </p>
//                         <p className={`text-xs ${
//                           isScrolled || !isHomePage || isOpen ? "text-gray-500" : "text-white/70"
//                         }`}>
//                           Administrator
//                         </p>
//                       </div>
...
const Navbar: React.FC<NavbarProps> = ({ user, onLoginClick }) => {
  ...
  return (
    <>
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 bg-white shadow-sm">
        <div
          className={`w-full transition-all duration-300 bg-white shadow-sm px-4 sm:px-6 lg:px-8 py-4 ${
            isScrolled || !isHomePage

...
// import { Save, Shield, Globe, Mail, Bell, Lock, User, Database, Server, Palette, Image, Upload, RefreshCw, Eye, Home, Menu, X } from 'lucide-react';
...
//     // Don't reset to defaults on error, keep existing values
...
//             `${API_BASE_URL}/settings/logos/upload`,
//             formData,
//             getUploadHeaders()
//           );
...
//             setSettings(prev => ({
//               ...prev,
//               [logoKey]: response.data.data.fullUrl
//             }));
//             resolve(true);
//           } else {
...
//       }),
//       {
//         loading: `Uploading ${type} logo...`,
//         success: `${type} logo uploaded successfully!`,
//         error: (err) => err.message || `Failed to upload ${type} logo`
//       }
//     );
//   };
...
//           const response = await axios.post(
//             `${API_BASE_URL}/settings/logos/favicon`,
//             formData,
//             getUploadHeaders()
//           );
...
//             setSettings(prev => ({
//               ...prev,
//               favicon: response.data.data.fullUrl
//             }));
//             resolve(true);
//           } else {
//             reject(new Error(response.data.message));
...
//         error: (err) => err.message || 'Failed to upload favicon'
//       }
//     );
//   };
...
//         try {
//           const response = await axios.post(
//             `${API_BASE_URL}/settings/logos/reset`,
//             {},
//             getAuthHeaders()
//           );
...
//       }),
//       {
//         loading: 'Resetting logos...',
//         success: 'Logos reset to defaults successfully!',
//         error: (err) => err.message || 'Failed to reset logos'
//       }
//     );
//   };

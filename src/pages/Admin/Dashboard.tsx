...
// const socketRef = useRef<Socket | null>(null);   const userMenuRef = useRef<HTMLDivElement>(null);
...
//     }
//   };
//   // ✅ ADD Socket.IO connection useEffect
// useEffect(() => {
...
//     setEnquiryNotifications(prev => [notification, ...prev]);
//     setUnreadEnquiryCount(prev => prev + 1);
...
//     const notificationInterval = setInterval(fetchEnquiryNotifications, socketConnected ? 60000 : 10000);
//   const statsInterval = setInterval(fetchDashboardStats, socketConnected ? 60000 : 30000);
//   const careerInterval = setInterval(fetchCareerNotifications, socketConnected ? 60000 : 10000);
...
const enquiryFetchTimeoutRef = useRef<ReturnType<typeof setTimeout> | null>(null);
  ...
  // Navigation items
  const navItems = [
    { path: '/admin',             icon: LayoutDashboard, label: 'Dashboard',    section: 'dashboard'    },
    { path: '/admin/home',        icon: Home,            label: 'Home Page',    section: 'home'         },
    { path: '/admin/services',    icon: Briefcase,       label: 'Services',     section: 'services'     },
    { path: '/admin/blog',        icon: FileText,        label: 'Blogs',        section: 'blog'         },
    { path: '/admin/testimonials',icon: ThumbsUp,        label: 'Testimonials', section: 'testimonials' },
    { path: '/admin/enquiries',   icon: MessageSquare,   label: 'Enquiries',    section: 'enquiries'    },
     { path: '/admin/case-studies',icon: FolderOpen,      label: 'Case Studies', section: 'casestudies'  },
    { path: '/admin/career',      icon: Users,           label: 'Careers',      section: 'career'       },
    { path: '/admin/team',        icon: User2,           label: 'Team Members', section: 'team'         },
